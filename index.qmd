...
- 2026-07 - Our github repo [ABRL: A Target-Faithful Autoformalization Harness and Lean 4 Library for Bandit and Reinforcement Learning Theory](https://github.com/DakeBU/Auto-Bandit-RL-Proof-In-Sleep/) and [Auto-Sampling-Theory-In-Sleep: A Hierarchical Automated Theorem Proving System for Sampling Theory](https://github.com/DakeBU/Auto-Sampling-Theory-In-Sleep) are available. Public lean libraries [BanditRLlib](https://dakebu.github.io/Auto-Bandit-RL-Proof-In-Sleep/) and [Samplinglib](https://dakebu.github.io/Auto-Sampling-Theory-In-Sleep/index.html) are welcoming contributors! The arXiv preparation is on the way. Please feel free to reach out and provide suggestions!
- 2026-06 - Attended the [Annual Summer School on Mathematical Aspects of Data Science](https://ims.nus.edu.sg/events/ma_datascience2026/) at the Institute for Mathematical Sciences, National University of Singapore.
- 2026-06 - Our github repo [ASPBE:Automatic State Preparation and Block Encoding for Quantum Computing](https://github.com/DakeBU/Quantum-Computing-Block-Encoding) is available, along with public lean library [QuantumComputinglib](https://dakebu.github.io/Quantum-Computing-Block-Encoding/) and user-facing [website](https://dakebu.github.io/Quantum-Computing-Block-Encoding/task-builder/index.html) (Under Constuction). The arXiv version is comming soon. Any feedback is welcome!
- 2026-06 - Our paper on [A Plug-in Doob h transform-induced Token-Ordering Module for Diffusion Language Models](https://arxiv.org/pdf/2604.24357) ([[code](https://github.com/DakeBU/DPRM-DLLM)]) is selected as **Oral**, and [theoretical explanation and solution to exploration dilemma in LLM post-training](https://openreview.net/forum?id=3dPpfbmZ3n) ([[code](https://github.com/DakeBU/Distribution-Bias-of-Post-training)]) is rewarded as **spotlight** in **ICML 2026 Fogen**. 
...
- 2026-05 - One paper on [Provable benefit of transformer curriculum post-training](https://arxiv.org/pdf/2511.07372) ([[code](https://github.com/DakeBU/Curriculum-Post-training)]) accepted to **ICML 2026** ([[code](https://github.com/DakeBU/Curriculum-Post-training)]).  
...
- 2025-11 - One paper on [Provable benefit of transformer curriculum post-training](https://arxiv.org/pdf/2511.07372) ([[code](https://github.com/DakeBU/Curriculum-Post-training)]) is available on arXiv.
- 2025-01 — Two papers on [theoretical foundation of task vector in In-Context Learning](https://openreview.net/pdf?id=DbUmeNnNpt) ([[code](https://github.com/DakeBU/In-Context-Vector-Arithmetic-via-Retrieving-Task-Concepts)]), and [Multi-objective Reinforcement Learning with Lexicographic Rewards](https://openreview.net/pdf?id=RTHTyTsRT3) are accepted to **ICML 2025**.  
- 2024-09 — One paper on [In context learning with multi-concept word semantics](https://proceedings.neurips.cc/paper_files/paper/2024/file/73efab19ebde03ff0958f4f155483f57-Paper-Conference.pdf) ([[code](https://github.com/DakeBU/Transformers-Harness-Multi-Concept-Word-Semantics-for-Efficient-In-Context-Learning)]) is accepted to **NeurIPS 2024**.  
- 2024-01 — One paper on [theoretical foundation of neural active learning](https://arxiv.org/pdf/2406.03944) ([[code](https://github.com/DakeBU/Neural-Active-Learning-Succeeds-via-Prioritizing-Perplexing-Samples)]) accepted to **ICML 2024**.  
