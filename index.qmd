...
- 2026-05 - One paper on [Provable benefit of transformer curriculum post-training](https://arxiv.org/pdf/2511.07372) accepted to **ICML 2026**.  
- 2026-04 - Two papers on [Slowly Annealed Langevin Dynamics](https://sites.google.com/site/atsushinitanda/va-sald) and [A Plug-in Doob h transform-induced Token-Ordering Module for Diffusion Language Models](https://arxiv.org/pdf/2604.24357) are available online.
...
<div class="visitor-globe">
  <script type="text/javascript" id="mapmyvisitors"
    src="//mapmyvisitors.com/map.js?d=4xO3iLDzTFL_EWIQet3rdXqr0eP0pjxulJQecHYOusA&cl=ffffff&w=a">
  </script>

  <script type="text/javascript" id="mmvst_globe"
    src="//mapmyvisitors.com/globe.js?d=Ph6rFhe0tz2T1MSQg6JW0kk0CsDvNpN_ro5I7GQxBn0">
  </script>
</div>
