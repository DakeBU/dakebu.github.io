...
Focuses on the theory and algorithms of large-scale machine learning systems, spanning emergent in-context learning in Transformers, agentic AI, LLM and diffusion post-training/inference, continuous and discrete generative models, reinforcement learning, and sampling. Combines algorithm design, rigorous theory, open-source systems, and reproducible experiments to improve foundation-model training and inference.
...
- 22 Jun 2026–01 Jul 2026 - Attended the [Annual Summer School on Mathematical Aspects of Data Science](https://ims.nus.edu.sg/events/ma_datascience2026/) at the Institute for Mathematical Sciences, National University of Singapore.
- 2026-06 - Our github repo [Auto-Lean-in-Sleep: Block Encoding for Quantum Computing](https://github.com/DakeBU/Quantum-Computing-Block-Encoding) is available, along with user-facing [website](https://dakebu.github.io/Quantum-Computing-Block-Encoding/) with API (Under Constuction). The arXiv version is comming soon. Any feedback is welcome!
